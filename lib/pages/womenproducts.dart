...
class _WomenproductsPageState extends State<WomenproductsPage> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Women's Product", style: heading(context)),
            Expanded(
              child: ValueListenableBuilder(
                ...
                builder: (context, _, __) {
                  // filtered list every time notifier updates
                  final products = ProductService.getProducts()
                      .where((element) => element.code == 1)
                      .toList();
  ...
  void openProductDetail(Product product) async {
    ...
    if (result == true) {
      setState(
        () {},
      ); // optional, mostly ValueListenableBuilder will handle updates
    }
  }
}
